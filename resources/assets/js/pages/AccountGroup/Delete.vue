  ...
  <div class="row">
    <div class="col-lg-6 col-md-10 col-12 mx-auto">
      <div class="card card-body mx-3 mx-md-4 mt-3">
        ...
        <div class="card-body">
          Do you want to remove the "{{item.name}}" account group?
          <div class="text-center">
            <button class="btn mb-0 bg-gradient-secondary btn-md my-4 mb-2" @click="$router.push({path: '/account/groups'})">Cancel</button>
...
<script>
import { accountGroupDetailService, accountGroupDeleteService } from "../../api/accountGroup.js";
...
export default {
  ...
  methods: {
    ...
    async deleteItem() {
      ...
      try {
        let data;
        data = await accountGroupDeleteService(this.id);
        this.$store.dispatch('messages/add', {
          type: 'info',
          message: 'Account group has ben deleted'
        });
