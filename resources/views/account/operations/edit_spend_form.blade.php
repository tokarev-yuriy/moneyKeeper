{!! Form::open(array('url' => ((isset($obItem) && $obItem->id)?$paths['update'].'/'.$obItem->id:$paths['add']))) !!}
  ...
  <div class="form-row">
     <div class="col-6 form-group">
         ...
         @php
           echo \App\MoneyKeeper\Helpers\Form::dropdownSelect('category_id', \App\MoneyKeeper\Models\Operation::getTypeCategoriesWithIcons('spend'), Input::get('category_id', isset($obItem)?$obItem->category_id:''), (isset($errors) && $errors->has('category_id') ? 'is-invalid' : ''));
         @endphp
     ...
     <div class="col-6 form-group">
         <label for="wallet_from_id" class="mb-0">{{ trans('mkeep.wallet') }}</label>
          @php
     ...
     <div class="row form-group">
        ...
        <div class="col-6 pr-0">
            <button id="btn-type-drop" type="button" class="btn btn-danger pull-right dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="fa fa-long-arrow-left"></i>&nbsp;&nbsp;{{ trans('mkeep.add_spend') }}
            </button>
