 ...
 */
class CrudListController extends BaseController {
    ...
    public function __construct()
    {
        ...
        $this->beforeFilter('csrf', array('only'=>array('postAdd', 'postUpdate')));
    ...
    public function getAdd()
    {
        ...
        if (Request::ajax()) {
            return View::make($this->__getView('form'));
        }
        
        return View::make($this->__getView('edit'))->nest('editForm', $this->__getView('form'));
    }
    ...
    public function getUpdate($id)
    {
        ...
        if (Request::ajax()) {
            return View::make($this->__getView('form'), array('obItem'=>$obItem));
        }
        return View::make($this->__getView('edit'),array('obItem'=>$obItem))->nest('editForm', $this->__getView('form'), array('obItem'=>$obItem));
    }
    ...
    protected function __processItem($obItem) {
        ...
        $messages = $validator->messages();
         ...
         if (Request::ajax()) {
            return View::make($this->__getView('form'), array(
                'errors' => $messages,
                'obItem'=>$obItem
            ));
        }
        
        return View::make($this->__getView('edit'), array(
            'errors' => $messages,
            'obItem'=>$obItem
