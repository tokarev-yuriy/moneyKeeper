   <?=Form::open(array('url' => ((isset($obItem) && $obItem->id)?$paths['update'].'/'.$obItem->id:$paths['add'])))?>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-6">
                <?=Form::select('category_id', Operation::getTypeCategories('spend'), Input::get('category_id', isset($obItem)?$obItem->category_id:''), array('class'=>(isset($errors) && $errors->has('category_id') ? 'form-control is-invalid' : 'form-control')))?>
