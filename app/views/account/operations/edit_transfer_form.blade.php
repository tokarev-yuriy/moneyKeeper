   <?=Form::open(array('url' => ((isset($obItem) && $obItem->id)?$paths['update'].'/'.$obItem->id:$paths['add'])))?>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-6">
                <?=Form::select('wallet_to_id', Operation::getWallets(), Input::get('wallet_to_id', isset($obItem)?$obItem->wallet_to_id:''), array('class'=>(isset($errors) && $errors->has('wallet_to_id') ? 'form-control is-invalid' : 'form-control')))?>
