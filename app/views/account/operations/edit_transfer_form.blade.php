   <?=Form::open(array('url' => ((isset($obItem) && $obItem->id)?$paths['update'].'/'.$obItem->id:$paths['add'])))?>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-6">
                <?=Form::select('category_id', Operation::getTypeCategories('transfer'), Input::get('category_id', isset($obItem)?$obItem->category_id:''), array('class'=>(isset($errors) && $errors->has('category_id') ? 'form-control is-invalid' : 'form-control')))?>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-6">
                <?=Form::select('wallet_to_id', Operation::getWallets(), Input::get('wallet_to_id', isset($obItem)?$obItem->wallet_to_id:Session::get('wallet_to_id')), array('class'=>(isset($errors) && $errors->has('wallet_to_id') ? 'form-control is-invalid' : 'form-control')))?>
