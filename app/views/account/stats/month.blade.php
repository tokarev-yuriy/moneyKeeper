...
@section('content')
    ...
    <div class="container widget" id="total-area" data-url="/account/stat/monthtotal" data-type="chart" data-chart-type="area" data-chart-stacktype="none" style="min-height: 500px;">
    ...
    <div class="container widget" id="income-area" data-url="/account/stat/monthspend" data-type="chart" data-chart-type="area" style="min-height: 500px;">
    ...
    <div class="container widget" id="spend-area" data-url="/account/stat/monthincome" data-type="chart" data-chart-type="area" style="min-height: 500px;">
